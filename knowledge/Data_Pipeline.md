...
| **Spot Yield Curves** | Triggered by the `FidelityQuotes` task (3x daily on weekdays), chained after it | `YieldCurves/scripts/updateSpotYieldCurves.js` | `Treasuries/SpotYieldCurves.csv` ([S13](./DataStores.md#s13)), `Treasuries/BreakevenInflation.csv` ([S14](./DataStores.md#s14)), `Treasuries/BidAskSpreads.csv` ([S15](./DataStores.md#s15)) |
